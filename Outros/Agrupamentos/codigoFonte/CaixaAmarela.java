...
/**
 * Write a description of class CaixaAmarela here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class CaixaAmarela extends Actor
{
    public Fase1 fase1; //declaracao
    
    public CaixaAmarela(){
        GreenfootImage amarela = new GreenfootImage("images/yellow.png");
        setImage(amarela);
        int largura1 = 150;
        int altura1 = 50;
        
        GreenfootImage imagemRedimensionada = new GreenfootImage(amarela);
        imagemRedimensionada.scale(largura1,altura1);
        setImage(imagemRedimensionada);  
    }
          
    /**
     * Act - do whatever the CaixaAmarela wants to do. This method is called whenever
    ...
    public void act()
    {
        ...
        if (objeto != null && objeto instanceof Figuras) {
            ...
            if (figura.getCor() != null && figura.getCor().equals(Color.YELLOW)) {
