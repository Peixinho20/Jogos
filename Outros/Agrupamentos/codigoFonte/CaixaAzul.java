...
/**
 * Write a description of class CaixaAzul here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class CaixaAzul extends Actor
{
    public Fase1 fase1; //declaracao
    
    public CaixaAzul(){
        GreenfootImage azul = new GreenfootImage("images/blue.png");
        setImage(azul);
        int largura1 = 150;
        int altura1 = 50;
        
        GreenfootImage imagemRedimensionada = new GreenfootImage(azul);
        imagemRedimensionada.scale(largura1,altura1);
        setImage(imagemRedimensionada);  
    }
          
    /**
     * Act - do whatever the CaixaAzul wants to do. This method is called whenever
    ...
    public void act()
    {
        ...
        if (objeto != null && objeto instanceof Figuras) {
            ...
            if (figura.getCor() != null && figura.getCor().equals(Color.BLUE)) {
