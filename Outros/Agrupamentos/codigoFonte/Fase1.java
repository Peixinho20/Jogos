...
public class Fase1 extends World
{
    ...
    public void Pontuacao(){
        ...
        if (pontuacao >= 5) {  // Verifica se a pontuação atingiu o valor necessário para passar para a Fase2
            Fase2 fase2 = new Fase2();  // Cria uma instância da Fase2
            Greenfoot.setWorld(fase2);  // Muda para a Fase2
        }
    }
